...
// 用于保护 addedURLs
func GetEnInfoLeakix(response string, DomainsIP *outputfile.DomainsIP) (*Utils.EnInfos, map[string]*outputfile.ENSMap) {
	...
	Utils.DomainTableShow(keyword, data, "Leakix")
